...
module.exports = class NineToFiveGoogleApp extends Homey.App {

  async getFeed() {
    try {
      const rssUrl = "https://9to5google.com/feed/";
   ...
   */
  async onInit() {
    this.log('9to5Google has been initialized');
    ...
    this.homey.setInterval(async () => {
      try {
        ...
        this.error('Error fetching 9to5Google feed:', error);
      }
    } , 15 * 60 * 1000);
    try {
